...
export function Header() {
  return (
    <header className="sticky top-4 z-50 mx-auto max-w-[1160px] px-4">
      <div className="flex items-center justify-between bg-cream/90 backdrop-blur-md rounded-2xl px-5 py-3 shadow-sm border border-border-light">
